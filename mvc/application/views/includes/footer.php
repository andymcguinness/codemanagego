...
<footer class="row">
    <div class="large-12 small-12 columns copyright">Copyright Maia "Cat" McGuinness 2013</div>
</footer>
...
<script>
    document.write('<script src=' +
        ('__proto__' in {} ? '<?php echo base_url(); ?>assets/js/vendor/zepto' : '<?php echo base_url(); ?>assets/js/vendor/jquery') +
        '.js><\/script>')
</script>
