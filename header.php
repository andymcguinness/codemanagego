...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <header class="row">
            <div class="large-10 large-uncentered small-6 small-centered columns title"><a href="index.php">Code, Manage, Go!</a></div>
            <a href="#"><div class="large-2 large-uncentered small-6 small-centered columns sign-in">Sign In</div></a>
        </header>